...
MACHINE     = Heating
TARGET      = sfun
CHART_SRCS 	= c1_Heating.c c2_Heating.c c3_Heating.c c4_Heating.c c5_Heating.c
MACHINE_SRC	= Heating_sfun.c
MACHINE_REG = Heating_sfun_registry.c
MAKEFILE    = Heating_sfun.mak
