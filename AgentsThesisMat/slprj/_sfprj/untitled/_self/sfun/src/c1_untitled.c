...
static const char * c1_debug_family_names[5] = { "nargin", "nargout", "house",
  "stunde", "Pcom" };
...
static real_T c1_emlrt_marshallIn(SFc1_untitledInstanceStruct *chartInstance,
  const mxArray *c1_Pcom, const char_T *c1_identifier);
  ...
  *chartInstance)
{
  ...
  real_T *c1_Pcom;
  c1_Pcom = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c1_st = NULL;
  c1_st = NULL;
  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_createcellarray(2), FALSE);
  c1_hoistedGlobal = *c1_Pcom;
  ...
  const mxArray *c1_st)
{
  ...
  *c1_Pcom = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u,
    0)), "Pcom");
...
static void sf_c1_untitled(SFc1_untitledInstanceStruct *chartInstance)
{
  ...
  real_T *c1_b_Pcom;
  real_T *c1_b_stunde;
  real_T (*c1_b_house)[8759];
  c1_b_stunde = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c1_b_Pcom = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c1_b_house = (real_T (*)[8759])ssGetInputPortSignal(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  for (c1_i0 = 0; c1_i0 < 8759; c1_i0++) {
    _SFD_DATA_RANGE_CHECK((*c1_b_house)[c1_i0], 0U);
  }

  _SFD_DATA_RANGE_CHECK(*c1_b_Pcom, 1U);
  _SFD_DATA_RANGE_CHECK(*c1_b_stunde, 2U);
  chartInstance->c1_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  c1_hoistedGlobal = *c1_b_stunde;
  for (c1_i1 = 0; c1_i1 < 8759; c1_i1++) {
    c1_house[c1_i1] = (*c1_b_house)[c1_i1];
  }

  c1_stunde = c1_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_nargout, 1U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c1_house, 2U, c1_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_stunde, 3U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_Pcom, 4U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 3);
  c1_Pcom = c1_house[(int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("house",
    (int32_T)_SFD_INTEGER_CHECK("stunde", c1_stunde), 1, 8759, 1, 0) - 1];
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, -3);
  ...
  const mxArray *c1_Pcom, const char_T *c1_identifier)
{
  ...
  c1_y = c1_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_Pcom), &c1_thisId);
  sf_mex_destroy(&c1_Pcom);
  return c1_y;
}
...
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  const mxArray *c1_Pcom;
  const char_T *c1_identifier;
  emlrtMsgIdentifier c1_thisId;
  real_T c1_y;
  SFc1_untitledInstanceStruct *chartInstance;
  chartInstance = (SFc1_untitledInstanceStruct *)chartInstanceVoid;
  c1_Pcom = sf_mex_dup(c1_mxArrayInData);
  ...
  *c1_inData)
{
  ...
  chartInstance = (SFc1_untitledInstanceStruct *)chartInstanceVoid;
  c1_mxArrayOutData = NULL;
  for (c1_i2 = 0; c1_i2 < 8759; c1_i2++) {
    c1_b_inData[c1_i2] = (*(real_T (*)[8759])c1_inData)[c1_i2];
  }

  for (c1_i3 = 0; c1_i3 < 8759; c1_i3++) {
    c1_u[c1_i3] = c1_b_inData[c1_i3];
  }

  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_create("y", c1_u, 0, 0U, 1U, 0U, 1, 8759), FALSE);
  sf_mex_assign(&c1_mxArrayOutData, c1_y, FALSE);
  return c1_mxArrayOutData;
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2048497144U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1290359665U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1229547431U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3109173678U);
}
...
mxArray *sf_c1_untitled_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("XMBQlrJwgZUalz4mBZTlw");
...
static const mxArray *sf_get_sim_state_info_c1_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Pcom\",},{M[8],M[0],T\"is_active_c1_untitled\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T *c1_stunde;
          real_T (*c1_house)[8759];
          c1_stunde = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
          c1_Pcom = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c1_house = (real_T (*)[8759])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c1_house);
          _SFD_SET_DATA_VALUE_PTR(1U, c1_Pcom);
          _SFD_SET_DATA_VALUE_PTR(2U, c1_stunde);
        }
      }
    } else {
...
static void mdlSetWorkWidths_c1_untitled(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(888032181U));
  ssSetChecksum1(S,(154215698U));
  ssSetChecksum2(S,(1051623897U));
  ssSetChecksum3(S,(3416926184U));
