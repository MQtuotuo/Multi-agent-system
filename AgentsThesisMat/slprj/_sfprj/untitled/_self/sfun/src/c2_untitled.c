...
static const char * c2_debug_family_names[5] = { "nargin", "nargout", "house",
  "stunde", "Pcom" };
...
static real_T c2_emlrt_marshallIn(SFc2_untitledInstanceStruct *chartInstance,
  const mxArray *c2_Pcom, const char_T *c2_identifier);
  ...
  *chartInstance)
{
  ...
  real_T *c2_Pcom;
  c2_Pcom = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c2_st = NULL;
  c2_st = NULL;
  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_createcellarray(2), FALSE);
  c2_hoistedGlobal = *c2_Pcom;
  ...
  const mxArray *c2_st)
{
  ...
  *c2_Pcom = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u,
    0)), "Pcom");
...
static void sf_c2_untitled(SFc2_untitledInstanceStruct *chartInstance)
{
  ...
  real_T *c2_b_Pcom;
  real_T *c2_b_stunde;
  real_T (*c2_b_house)[8759];
  c2_b_stunde = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c2_b_Pcom = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c2_b_house = (real_T (*)[8759])ssGetInputPortSignal(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 0U, chartInstance->c2_sfEvent);
  for (c2_i0 = 0; c2_i0 < 8759; c2_i0++) {
    _SFD_DATA_RANGE_CHECK((*c2_b_house)[c2_i0], 0U);
  }

  _SFD_DATA_RANGE_CHECK(*c2_b_Pcom, 1U);
  _SFD_DATA_RANGE_CHECK(*c2_b_stunde, 2U);
  chartInstance->c2_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c2_sfEvent);
  c2_hoistedGlobal = *c2_b_stunde;
  for (c2_i1 = 0; c2_i1 < 8759; c2_i1++) {
    c2_house[c2_i1] = (*c2_b_house)[c2_i1];
  }

  c2_stunde = c2_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 1U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_house, 2U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_stunde, 3U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_Pcom, 4U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 3);
  c2_Pcom = c2_house[(int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("house",
    (int32_T)_SFD_INTEGER_CHECK("stunde", c2_stunde), 1, 8759, 1, 0) - 1];
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, -3);
  ...
  const mxArray *c2_Pcom, const char_T *c2_identifier)
{
  ...
  c2_y = c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_Pcom), &c2_thisId);
  sf_mex_destroy(&c2_Pcom);
  return c2_y;
}
...
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  const mxArray *c2_Pcom;
  const char_T *c2_identifier;
  emlrtMsgIdentifier c2_thisId;
  real_T c2_y;
  SFc2_untitledInstanceStruct *chartInstance;
  chartInstance = (SFc2_untitledInstanceStruct *)chartInstanceVoid;
  c2_Pcom = sf_mex_dup(c2_mxArrayInData);
  ...
  *c2_inData)
{
  ...
  chartInstance = (SFc2_untitledInstanceStruct *)chartInstanceVoid;
  c2_mxArrayOutData = NULL;
  for (c2_i2 = 0; c2_i2 < 8759; c2_i2++) {
    c2_b_inData[c2_i2] = (*(real_T (*)[8759])c2_inData)[c2_i2];
  }

  for (c2_i3 = 0; c2_i3 < 8759; c2_i3++) {
    c2_u[c2_i3] = c2_b_inData[c2_i3];
  }

  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_create("y", c2_u, 0, 0U, 1U, 0U, 1, 8759), FALSE);
  sf_mex_assign(&c2_mxArrayOutData, c2_y, FALSE);
  return c2_mxArrayOutData;
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4113450812U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3654094563U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(613275564U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(838921947U);
}
...
mxArray *sf_c2_untitled_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("huqbJfAbDu2ltr056btnjH");
...
static const mxArray *sf_get_sim_state_info_c2_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Pcom\",},{M[8],M[0],T\"is_active_c2_untitled\",}}"
  };
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"house");
...

        {
          ...
          real_T *c2_stunde;
          real_T (*c2_house)[8759];
          c2_stunde = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
          c2_Pcom = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c2_house = (real_T (*)[8759])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c2_house);
          _SFD_SET_DATA_VALUE_PTR(1U, c2_Pcom);
          _SFD_SET_DATA_VALUE_PTR(2U, c2_stunde);
        }
      }
    } else {
...
static void mdlSetWorkWidths_c2_untitled(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1419788185U));
  ssSetChecksum1(S,(2337996225U));
  ssSetChecksum2(S,(1941693028U));
  ssSetChecksum3(S,(1815928967U));
