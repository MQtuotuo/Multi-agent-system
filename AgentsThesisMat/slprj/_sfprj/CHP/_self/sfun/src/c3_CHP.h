...
#ifndef typedef_SFc3_CHPInstanceStruct
#define typedef_SFc3_CHPInstanceStruct
...
typedef struct {
  ...
  uint8_T c3_is_active_c3_CHP;
} SFc3_CHPInstanceStruct;

#endif                                 /*typedef_SFc3_CHPInstanceStruct*/
...
extern void c3_CHP_method_dispatcher(SimStruct *S, int_T method, void *data);
